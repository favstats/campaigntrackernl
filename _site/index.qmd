...
party_colors <- c(
  ...
  "50PLUS"= "#7F2481",   # alias fixes grey tile
  ...
  "Satire"   = "#6A5ACD", # slate purple
  "Pro-Farmer"         = "#2E8B57", # farmer green
  "Progressive Account"= "#8A2BE2",  # vivid progressive violet
  "Vrede voor Dieren"= "#5496c6",  # vivid progressive violet
    # --- NEW: missing labels from your treemap screenshot ---
  "NCPN"           = "#CC0000", # communist red, distinct from SP/PvdA
  "Protest Accounts" = "#EE6677", # Tol Bright coral (color-blind–safe)
  "De Linie"       = "#AA3377"  # Tol Bright purple (distinct & CVD-safe)
)
party_colors <- party_colors[!duplicated(names(party_colors), fromLast = TRUE)]
