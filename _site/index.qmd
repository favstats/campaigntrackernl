...
# --- LAYOUT: use apex_grid for side-by-side, with controlled gap/height -------
# NOTE: apex_grid needs either grid height or individual chart heights set.  [oai_citation:5‡CRAN](https://cran.r-project.org/web/packages/apexcharter/apexcharter.pdf)
tagList(
  custom_css,
  apex_grid(
    disclaimer_overall, woki,
    ncol = 2,
    col_gap = "24px",
    height = "420px"
  )
