...
![](monitor1.png){#fig-exposure fig-cap="Exposure to AI-generated content (March 2024–May 2025)." fig-align="center"}
...
As shown in @fig-confidence, while exposure has grown, people’s *confidence* in spotting AI content has not collapsed in the way many feared. In 2024, **68%** said they were *not confident* in their ability to detect AI; by mid-2025, that figure dropped to **52%**. Still, skepticism about others’ ability remains widespread. **Journalists** are the most trusted group to recognize AI content, but even here, only **27%** of respondents express confidence. Trust is lowest in the general public—**76%** say they don’t trust ordinary people to detect AI—followed by **friends and family (69%)**.
