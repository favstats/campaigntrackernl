...
# CampAIgn Tracker Expands to the Netherlands: Monitoring AI in the 2025 Dutch General Election
...
This expansion occurs through the Hybrid Election Integrity Observatory Consortium, a collaborative network formed specifically to monitor the Dutch election. The consortium brings together organizations with complementary expertise in different aspects of digital campaigning and election integrity.

### Consortium members:

Stichting Post-X Society serves as the coordinating organization, providing project management and research infrastructure. Trollrensics contributes expertise in detecting coordinated inauthentic behavior and analyzing network patterns in political communication. AI Forensics specializes in investigating how AI systems operate within political and social contexts, bringing technical depth to content analysis. Justice for Prosperity focuses on the implications of digital campaigning practices for democratic participation and political equality. This combination of technical, analytical, and normative expertise enables comprehensive monitoring that addresses both the mechanics and the democratic implications of AI in campaigns.
